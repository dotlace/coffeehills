...
const LoginRegister: React.FC<LoginRegisterProps> = ({ onClose, onLoginSuccess }) => {
  ...
  const handleShowRegMsg = () => {
    setShowRegMsgModal(true); // Show success message

    // After 3 seconds, close RegMsgModal and switch to login
    setTimeout(() => {
...
//     // Close the Login/Register modal when RegMsgModal appears
//     setTimeout(() => {
//       setShowRegMsgModal(false);
//       setIsRegisterActive(false); // Reset to login form
//       onClose(); // Close LoginRegister.tsx completely
//     }, 3000);
//   };
...
// type LoginRegisterProps = {
//   onClose: () => void;
//   onLoginSuccess?: (username: string) => void; // Make it optional
// };
...
//         <div className="w-full mt-10 p-6">
//           {isRegisterActive ? (
//             <RegisterForm onToggle={() => setIsRegisterActive(false)} />
//           ) : (
//             <LoginForm onToggle={() => setIsRegisterActive(true)} onLoginSuccess={onLoginSuccess} />
//           )}
//         </div>
...
//         <div className="w-full mt-10 p-6">
//           {isRegisterActive ? (
//             <RegisterForm onToggle={() => setIsRegisterActive(false)} onLoginSuccess={onLoginSuccess} />
//           ) : (
//             <LoginForm onToggle={() => setIsRegisterActive(true)} onLoginSuccess={onLoginSuccess} />
//           )}
//         </div>
