    ...
    <section id="products" className="relative p-8 bg-[#3B2F2F] text-white">
      ...
      {selectedProduct && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4 z-50">
          <div 
            className="bg-amber-100 p-6 rounded-lg shadow-lg relative w-[400px] md:w-[500px] lg:w-[550px] min-h-[500px] flex flex-col items-center"
          >
            {/* Close Button */}
            <button
            ...
            <div className="w-full h-[250px] flex items-center justify-center overflow-hidden rounded-md bg-gray-200">
            ...
            {/* Product Details */}
            <h2 className="text-xl font-bold text-[#5C4033] mt-4">{selectedProduct.name}</h2>
            <p className="text-gray-600 text-center px-4">{selectedProduct.description}</p>
            <p className="text-lg font-bold text-[#634a20] mt-2">${selectedProduct.price}</p>
              ...
              onClick={() => {
                if (selectedProduct) {
                  addToCart({
                    ...selectedProduct,
                    quantity,
                    id: selectedProduct.id, // ✅ Keep ID as a string
                  });
